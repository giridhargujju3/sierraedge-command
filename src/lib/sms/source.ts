    ...
    alerts: offline
      ...
      : [
          ...
          },
          {
            ...
            time: clock(320),
            severity: "ok",
            message: "CO sensor baseline captured in clean air",
          },
          {
            id: "a3",
            time: clock(640),
            severity: "ok",
            message: "All temperature probes detected on the OneWire bus",
          },
          {
            id: "a4",
            time: clock(1200),
            severity: "ok",
            message: "Acoustic gain stages calibrated",
          },
        ],
    trends: offline
      ? []
